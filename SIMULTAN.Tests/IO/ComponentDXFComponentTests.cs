    ...
    public class ComponentDXFComponentTests : ComponentDXFTestsBase
    {
        ...
        public void WriteComponent()
        {
            SimComponent component = new SimComponent()
            {
                ...
                CurrentSlot = new SimTaxonomyEntryReference(TaxonomyUtils.GetDefaultSlot(SimDefaultSlotKeys.Cost)),
            ...
            long localId, bool isAutoGenerated, Color color)
        {
            ...
            Assert.AreEqual(currentSlot.Target, component.CurrentSlot.Target);
        ...
        internal static void CheckComponents(ProjectData projectData, Guid guid, Guid otherguid, SimFlowNetworkNode node)
        {
            ...
            CheckComponent(root, new SimTaxonomyEntryReference(jointTax), "Root Component", "Some\r\ndescriptive\r\ntext",
            ...
            //Parameter
            Assert.AreEqual(20011, child1.Component.Parameters.First(x => x.NameTaxonomyEntry.Name == "A1").Id.LocalId);
            ...
            Assert.AreEqual(child2.Component.Parameters.First(x => x.NameTaxonomyEntry.Name == "A"), calc.InputParams["x"]);
            Assert.AreEqual(1, calc.ReturnParams.Count);
            Assert.AreEqual(child2.Component.Parameters.First(x => x.NameTaxonomyEntry.Name == "B"), calc.ReturnParams["ret"]);
        ...
        public void ParseMultipleV8()
        {
            ...
            var root = projectData.Components.First();
            CheckComponent(root, new SimTaxonomyEntryReference(jointTax), "Root Component", "Some\r\ndescriptive\r\ntext",
                4, true, Color.FromArgb(230, 240, 10, 20));
            Assert.AreEqual(0, root.Parameters.Count);
        ...
        public void ParseMultipleV4()
        {
            ...
            //Parameter
            Assert.AreEqual(1076741825, child1.Component.Parameters.First(x => x.NameTaxonomyEntry.Name == "A1").Id.LocalId);
