...
{
    [TestClass]
    public class ComponentDxfBoolParameterTests
    {
        #region Parameter
        ...
        {
            SimBoolParameter parameter = new SimBoolParameter(99, "Parameter X",
                SimCategory.Cooling | SimCategory.Communication | SimCategory.Light_Artificial,
                SimInfoFlow.Output,
                true, "text value with spaces", null,
            ...
            AssertUtil.AreEqualMultiline(Properties.Resources.DXFSerializer_WriteParameterBool, exportedString);
        }
        ...
        public void WriteParameterWithPointer()
        {
            ...
            SimBoolParameter parameter = new SimBoolParameter(99, "Parameter X",
                SimCategory.Cooling | SimCategory.Communication | SimCategory.Light_Artificial,
                SimInfoFlow.Output,
                true, "text value with spaces", new SimMultiValueBigTableParameterSource(table, 0, 2),
                SimParameterOperations.EditValue | SimParameterOperations.EditName, SimParameterInstancePropagation.PropagateAlways, true);
            ...
            AssertUtil.AreEqualMultiline(Properties.Resources.DXFSerializer_WriteParameterWithPointer_Bool, exportedString);
        }
        ...
        public void WriteParameterWithGeometrySource()
        {
            ...
            SimBoolParameter parameter = new SimBoolParameter(99, "Parameter X",
                SimCategory.Cooling | SimCategory.Communication | SimCategory.Light_Artificial,
                SimInfoFlow.Output,
                true, "text value with spaces", valueSource,
            ...
            AssertUtil.AreEqualMultiline(Properties.Resources.DXFSerializer_WriteParameterWithGeometrySourceBool, exportedString);
        }
        ...
        public void WriteParameterWithTaxonomyEntry()
        {
            ...
            AssertUtil.AreEqualMultiline(Properties.Resources.DXFSerializer_WriteParameterWithTaxonomyEntry_Bool, exportedString);
        }
        ...
        public void WriteBigTablePointer()
        {
            ...
            SimBoolParameter parameter = new SimBoolParameter(99, "Parameter X",
                SimCategory.Cooling | SimCategory.Communication | SimCategory.Light_Artificial,
                SimInfoFlow.Output,
                true, "text value with spaces", new SimMultiValueBigTableParameterSource(table, 2, 1),
                SimParameterOperations.EditValue | SimParameterOperations.EditName, SimParameterInstancePropagation.PropagateAlways, true);
            parameter.Id = new SimId(project, 99);
        ...
        public void ParseField3DPointer()
        {
            ...
            //Test
            SimBoolParameter parameter = null;


            using (DXFStreamReader reader = new DXFStreamReader(StringStream.Create(Resources.DXFSerializer_ReadMVPointer_Field3DV19_Bool)))
            {
                var info = new DXFParserInfo(project.GlobalID, projectData);
                info.FileVersion = 19;

                reader.Read();
                parameter = ComponentDxfIOComponents.BaseParameterEntityElement.Parse(reader, info) as SimBoolParameter;
            }
        ...
        public void ParseFunctionPointer()
        {
            ...
            using (DXFStreamReader reader = new DXFStreamReader(StringStream.Create(Resources.DXFSerializer_ReadMVPointer_FunctionV12_Bool)))
            {
                var info = new DXFParserInfo(project.GlobalID, projectData);
                info.FileVersion = 19;
        ...
        public void ParseParameterV19()
        {
            ...
            using (DXFStreamReader reader = new DXFStreamReader(StringStream.Create(Resources.DXFSerializer_ReadCODXF_BoolParameterV19)))
            {
