...
namespace SIMULTAN.Tests.Parameters
{
    ...
    public class BoolParameterTests : BaseProjectTest
    {
        ...
        private void CheckParameterPropertyChanges<T>(string prop, T value)
        {
            ...
            var bphParameter = bphComponent.Parameters.First(x => x.NameTaxonomyEntry.Name == "BPHParameter_Bool");
        ...
        public void GetReferencedParameter()
        {
            ...
            var refTarget = projectData.Components.First(x => x.Name == "ReferenceSource").Parameters.First(x => x.NameTaxonomyEntry.Name == "Bool_A");
