...
namespace SIMULTAN.Tests.Geometry.GeometryValueSource
{
    ...
    public class VolumeCeilingElevationGeometrySourceTests : BaseProjectTest
    {
        ...
        public void GeometryChanged()
        {
            ...
            gm.Geometry.Vertices.First(x => x.Name == "Vertex - FrontLeftRoof").Position += new Vector3D(0, 5, 0);
            gm.Geometry.Vertices.First(x => x.Name == "Vertex - FrontRightRoof").Position += new Vector3D(0, 5, 0);
            gm.Geometry.Vertices.First(x => x.Name == "Vertex - BackLeftRoof").Position += new Vector3D(0, 5, 0);
            gm.Geometry.Vertices.First(x => x.Name == "Vertex - BackRightRoof").Position += new Vector3D(0, 5, 0);
        ...
        public void GeometryReplaced()
        {
            ...
            copyGeometry.Vertices.First(x => x.Name == "Vertex - FrontLeftRoof").Position += new Vector3D(0, 5, 0);
            copyGeometry.Vertices.First(x => x.Name == "Vertex - FrontRightRoof").Position += new Vector3D(0, 5, 0);
            copyGeometry.Vertices.First(x => x.Name == "Vertex - BackLeftRoof").Position += new Vector3D(0, 5, 0);
            copyGeometry.Vertices.First(x => x.Name == "Vertex - BackRightRoof").Position += new Vector3D(0, 5, 0);
