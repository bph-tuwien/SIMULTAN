...
{
    [TestClass]
    public class VolumeCeilingElevationGeometrySourceTests : BaseProjectTest
    {
        ...
        public void AddSource()
        {
            ...
            param.ValueSource = new SimGeometryParameterSource(SimGeometrySourceProperty.VolumeCeilingElevation);
        ...
        public void GeometryChanged()
        {
            ...
            gm.Geometry.Vertices.First(x => x.Name == "Vertex - FrontLeftRoof").Position += new SimVector3D(0, 5, 0);
            gm.Geometry.Vertices.First(x => x.Name == "Vertex - FrontRightRoof").Position += new SimVector3D(0, 5, 0);
            gm.Geometry.Vertices.First(x => x.Name == "Vertex - BackLeftRoof").Position += new SimVector3D(0, 5, 0);
            gm.Geometry.Vertices.First(x => x.Name == "Vertex - BackRightRoof").Position += new SimVector3D(0, 5, 0);

            AssertUtil.AssertDoubleEqual(25.0, param.Value);
        ...
        public void VolumeMissingAdded()
        {
            ...
            AssertUtil.AssertDoubleEqual(15.0, (double)volComp.Instances[0].InstanceParameterValuesPersistent[param]);
        ...
        public void GeometryReplaced()
        {
            ...
            copyGeometry.Vertices.First(x => x.Name == "Vertex - FrontLeftRoof").Position += new SimVector3D(0, 5, 0);
            copyGeometry.Vertices.First(x => x.Name == "Vertex - FrontRightRoof").Position += new SimVector3D(0, 5, 0);
            copyGeometry.Vertices.First(x => x.Name == "Vertex - BackLeftRoof").Position += new SimVector3D(0, 5, 0);
            copyGeometry.Vertices.First(x => x.Name == "Vertex - BackRightRoof").Position += new SimVector3D(0, 5, 0);
        ...
        public void GeometryReplacedFaceReAdded()
        {
            ...
            AssertUtil.AssertDoubleEqual(20.0, param.Value);
            AssertUtil.AssertDoubleEqual(20.0, (double)volComp.Instances[0].InstanceParameterValuesPersistent[param]);
        }
