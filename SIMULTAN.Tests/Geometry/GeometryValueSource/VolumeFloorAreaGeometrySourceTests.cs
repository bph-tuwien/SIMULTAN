...
{
    [TestClass]
    public class VolumeFloorAreaGeometrySourceTests : BaseProjectTest
    {
        ...
        public void AddSource()
        {
            ...
            var faceComp = this.projectData.Components.First(x => x.Name == "Volume 3");
            ...
            param.ValueSource = new SimGeometryParameterSource(SimGeometrySourceProperty.VolumeFloorArea);
        ...
        public void OpenGeometry()
        {
            ...
            AssertUtil.AssertDoubleEqual(200.0, (double)faceComp.Instances[0].InstanceParameterValuesPersistent[param]);
        }
        [TestMethod]
        ...
        public void GeometryChanged()
        {
            ...
            gm.Geometry.Vertices.First(x => x.Name == "Vertex - B3 - BackRightBottom").Position += new SimVector3D(0, 0, -5);
            gm.Geometry.Vertices.First(x => x.Name == "Vertex - B3 - BackLeftBottom").Position += new SimVector3D(0, 0, -5);

            AssertUtil.AssertDoubleEqual(250.0, param.Value);
            AssertUtil.AssertDoubleEqual(250.0, (double)faceComp.Instances[0].InstanceParameterValuesPersistent[param]);
        }
        [TestMethod]
        ...
        public void VolumeRemoved()
        {
            ...
            var volComp = this.projectData.Components.First(x => x.Name == "Volume 3");
            var param = volComp.Parameters.OfType<SimDoubleParameter>().First(x => x.NameTaxonomyEntry.Text == "GeometryParam");
            ...
            var volume = gm.Geometry.Volumes.FirstOrDefault(x => x.Name == "Split Volume");
        ...
        public void VolumeMissingAdded()
        {
            ...
            AssertUtil.AssertDoubleEqual(200.0, param.Value);
            AssertUtil.AssertDoubleEqual(200.0, (double)volComp.Instances[0].InstanceParameterValuesPersistent[param]);
        ...
        public void VolumeReadd()
        {
            ...
            var vol = gm.Geometry.Volumes.First(x => x.Name == "Split Volume");
        ...
        public void GeometryReplaced()
        {
            ...
            copyGeometry.Vertices.First(x => x.Name == "Vertex - B3 - BackRightBottom").Position += new SimVector3D(0, 0, -5);
            copyGeometry.Vertices.First(x => x.Name == "Vertex - B3 - BackLeftBottom").Position += new SimVector3D(0, 0, -5);
        ...
        public void GeometryReplacedFaceRemoved()
        {
            ...
            var copyGeometry = gm.Geometry.Clone();
            var vol = copyGeometry.Volumes.First(x => x.Name == "Split Volume");
        ...
        [TestMethod]
        public void GeometryReplacedMissingVolumeAdded()
        {
            LoadProject(geometrySourceProject);
        ...
        public void GeometryReplacedFaceReAdded()
        {
            ...
            var copyGeometry = gm.Geometry.Clone();
            var volume = copyGeometry.Volumes.FirstOrDefault(x => x.Name == "Split Volume");
        ...
        public void AddInstance()
        {
            ...
            //Add instance
            var bottomVolume = gm.Geometry.Volumes.First(x => x.Name == "Upper Volume");
            faceComp.Instances.Add(new SimComponentInstance(SimInstanceType.Entity3D, gm.File.Key, bottomVolume.Id));

            //Check
            AssertUtil.AssertDoubleEqual(400.0, param.Value);
            AssertUtil.AssertDoubleEqual(200.0, (double)faceComp.Instances[0].InstanceParameterValuesPersistent[param]);
            AssertUtil.AssertDoubleEqual(200.0, (double)faceComp.Instances[1].InstanceParameterValuesPersistent[param]);
        }
        [TestMethod]
        ...
        public void ComponentAdded()
        {
            ...
            var volume = gm.Geometry.Volumes.First(x => x.Name == "Split Volume");
        ...
        public void MemoryLeakTestSourceRemoved()
        {
            ...
            var comp = projectData.Components.First(x => x.Name == "Volume 3");
