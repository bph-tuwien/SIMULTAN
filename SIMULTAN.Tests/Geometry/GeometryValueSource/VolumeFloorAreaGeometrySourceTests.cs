...
namespace SIMULTAN.Tests.Geometry.GeometryValueSource
{
    ...
    public class VolumeFloorAreaGeometrySourceTests : BaseProjectTest
    {
        ...
        public void GeometryChanged()
        {
            ...
            gm.Geometry.Vertices.First(x => x.Name == "Vertex - B3 - BackRightBottom").Position += new Vector3D(0, 0, -5);
            gm.Geometry.Vertices.First(x => x.Name == "Vertex - B3 - BackLeftBottom").Position += new Vector3D(0, 0, -5);
        ...
        public void GeometryReplaced()
        {
            ...
            copyGeometry.Vertices.First(x => x.Name == "Vertex - B3 - BackRightBottom").Position += new Vector3D(0, 0, -5);
            copyGeometry.Vertices.First(x => x.Name == "Vertex - B3 - BackLeftBottom").Position += new Vector3D(0, 0, -5);
