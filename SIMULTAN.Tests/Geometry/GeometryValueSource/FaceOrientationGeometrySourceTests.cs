...
namespace SIMULTAN.Tests.Geometry.GeometryValueSource
{
    ...
    public class FaceOrientationGeometrySourceTests : BaseProjectTest
    {
        ...
        public void GeometryChanged()
        {
            ...
            gm.Geometry.Vertices.First(x => x.Name == "Vertex - FrontRightTop").Position += new SimVector3D(20, 0, 0);
            gm.Geometry.Vertices.First(x => x.Name == "Vertex - FrontRightBottom").Position += new SimVector3D(20, 0, 0);
        ...
        public void GeometryReplaced()
        {
            ...
            copyGeometry.Vertices.First(x => x.Name == "Vertex - FrontRightTop").Position += new SimVector3D(20, 0, 0);
            copyGeometry.Vertices.First(x => x.Name == "Vertex - FrontRightBottom").Position += new SimVector3D(20, 0, 0);
        ...
        public void ComponentAdded()
        {
            ...
            newComp.Instances.Add(new SimComponentInstance(SimInstanceType.AttributesFace, gm.File.Key, leftFace.Id));
