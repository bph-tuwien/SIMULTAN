...
namespace SIMULTAN.Tests.Values
{
    ...
    public class MultiValueBigTableBoolPointerTests : BaseProjectTest
    {
        ...
        public void PointerParameterTest()
        {
            ...
            var param = comp.Parameters.OfType<SimBoolParameter>().First(x => x.NameTaxonomyEntry.Text == "Target_Bool");
        ...
        public void PointerParameterChangedTest()
        {
            ...
            var comp = projectData.Components.First(x => x.Name == "WithPointer_Bool");
            var param = comp.Parameters.OfType<SimBoolParameter>().First(x => x.NameTaxonomyEntry.Text == "Target_Bool");
            var colParam = comp.Parameters.OfType<SimDoubleParameter>().First(x => x.NameTaxonomyEntry.Text == "Target_Bool.ValuePointer.OffsetColumn");
            var rowParam = comp.Parameters.OfType<SimDoubleParameter>().First(x => x.NameTaxonomyEntry.Text == "Target_Bool.ValuePointer.OffsetRow");
        ...
        public void AddPointerParameterTest()
        {
            ...
            var colParam = comp.Parameters.OfType<SimDoubleParameter>().FirstOrDefault(x => x.NameTaxonomyEntry.Text == "Target_Bool.ValuePointer.OffsetColumn");
            var rowParam = comp.Parameters.OfType<SimDoubleParameter>().FirstOrDefault(x => x.NameTaxonomyEntry.Text == "Target_Bool.ValuePointer.OffsetRow");
