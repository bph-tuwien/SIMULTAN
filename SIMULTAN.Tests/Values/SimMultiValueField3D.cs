...
namespace SIMULTAN.Tests.Values
{
    ...
    public class SimMultiValueField3DTests
    {
        ...
        public void Ctor()
        {
            ...
            Assert.AreEqual(MultiValueType.FIELD_3D, mvt.MVType);
        ...
        public void CtorParsing()
        {
            ...
            Assert.AreEqual(MultiValueType.FIELD_3D, table1.MVType);
            ...
            Assert.AreEqual(MultiValueType.FIELD_3D, table2.MVType);
