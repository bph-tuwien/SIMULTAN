...
namespace SIMULTAN.Tests.Values
{
    ...
    /// </summary>
    [TestClass]
    public class MultiValueBigTableIntegerPointerTests : BaseProjectTest
    {
        ...
        public void GetValueTests()
        {
            ...
            var ptr = new SimMultiValueBigTableParameterSource(data.table, 1, 2);
            Assert.AreEqual(5002, ptr.GetValue());

            ptr = new SimMultiValueBigTableParameterSource(data.table, -1, -1);
            Assert.IsNull(ptr.GetValue());
        }
        ...
        public void IsSamePointerTest()
        {
            ...
            var data2 = SimMultiValueBigTableTests.IntTestDataTable(4, 3);
        ...
        public void DataChangedTest()
        {
            ...
            var ptr = new SimMultiValueBigTableParameterSource(data.table, 1, 2);
            Assert.AreEqual(5002, Convert.ToInt32(ptr.GetValue()));
            ...
            Assert.AreEqual(999, Convert.ToInt32(ptr.GetValue()));
        }
        ...
        public void DataReplacedTest()
        {
            ...
            var ptr = new SimMultiValueBigTableParameterSource(data.table, 1, 2);
            Assert.AreEqual(5002.0, Convert.ToInt32(ptr.GetValue()));
            ...
            Assert.AreEqual(1, eventCount);
            Assert.AreEqual(10002.0, Convert.ToInt32(ptr.GetValue()));
        }

        [TestMethod]
        public void ColumnsChangedTest()
        {
            var data = SimMultiValueBigTableTests.IntTestDataTable(3, 5);
        ...
        {
            var data = SimMultiValueBigTableTests.IntTestDataTable(5, 3);

            var ptr = new SimMultiValueBigTableParameterSource(data.table, 2, 1);
            Assert.AreEqual(10001.0, Convert.ToInt32(ptr.GetValue()));
        ...
        public void PointerParameterTest()
        {
            ...
            //Find ptr
            var comp = projectData.Components.First(x => x.Name == "WithPointer_Int");
            var param = comp.Parameters.OfType<SimIntegerParameter>().First(x => x.NameTaxonomyEntry.Name == "Target_Int");
            ...
            Assert.AreEqual(20003, Convert.ToInt32(ptr.GetValue()));
        }
        ...
        public void PointerParameterChangedTest()
        {
            ...
            var comp = projectData.Components.First(x => x.Name == "WithPointer_Int");
            var param = comp.Parameters.OfType<SimIntegerParameter>().First(x => x.NameTaxonomyEntry.Name == "Target_Int");
            var colParam = comp.Parameters.OfType<SimDoubleParameter>().First(x => x.NameTaxonomyEntry.Name == "Target_Int.ValuePointer.OffsetColumn");
            var rowParam = comp.Parameters.OfType<SimDoubleParameter>().First(x => x.NameTaxonomyEntry.Name == "Target_Int.ValuePointer.OffsetRow");
            ...
            Assert.AreEqual(20001, Convert.ToInt32(ptr.GetValue()));

            rowParam.Value = 1;
            Assert.AreEqual(2, eventCounter);
            Assert.AreEqual(15001, Convert.ToInt32(ptr.GetValue()));
        }
        ...
        public void RemovePointerParameterTest()
        {
            ...
            Assert.AreEqual(1, eventCounter);
            Assert.AreEqual(20002, Convert.ToInt32(ptr.GetValue()));


            comp.Parameters.Remove(rowParam);
            Assert.AreEqual(2, eventCounter);
            Assert.AreEqual(10002, Convert.ToInt32(ptr.GetValue()));
        ...
        public void AddPointerParameterTest()
        {
            ...
            var colParam = comp.Parameters.OfType<SimDoubleParameter>().FirstOrDefault(x => x.NameTaxonomyEntry.Name == "Target_Int.ValuePointer.OffsetColumn");
            var rowParam = comp.Parameters.OfType<SimDoubleParameter>().FirstOrDefault(x => x.NameTaxonomyEntry.Name == "Target_Int.ValuePointer.OffsetRow");
