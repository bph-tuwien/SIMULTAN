...
namespace SIMULTAN.Serializer.CODXF
{
    ...
    public static class ComponentDxfIOComponents
    {
        ...
        public enum ParameterType
        {
            ...
            Enum = 4,
            /// <summary>
            /// value used for saving <see cref="SimDoubleListParameter"> and it´s instances </see>
            /// </summary>
            DoubleList = 10
        }
        ...
        private static object GetParameterInstanceValue(DXFParserResultSet data, ParameterType parameterType, DXFParserInfo info, SimId paramId)
        {
            ...
            switch (parameterType)
            {
                ...
                case ParameterType.DoubleList:
                    return DXFDataConverter<SimParameterValueCollection<double>>.P.FromDXFString(stringVal, info);
                default:
                    return null;
            }
        ...
        internal static void WriteParameter(SimBaseParameter parameter, DXFStreamWriter writer)
        {
            ...
            if (parameter is SimDoubleListParameter doubleListParam)
            {
                WriteDoubleListParameter(doubleListParam, writer);
            }
        }
        ...
        private static void WriteDoubleListParameter(SimDoubleListParameter parameter, DXFStreamWriter writer)
        {
            if (parameter == null)
                throw new ArgumentNullException(nameof(parameter));
            if (writer == null)
            ...
            writer.Write(ParamStructCommonSaveCode.ENTITY_START, ParamStructTypes.PARAMETER);
            writer.Write(ParameterSaveCode.PARAMTYPE, ParameterType.DoubleList);
            writer.Write(ParamStructCommonSaveCode.ENTITY_LOCAL_ID, parameter.Id.LocalId);
            ...
            // TODO ask Bernhard if we wanna write CSV or DXF arrays
            writer.Write(ParameterSaveCode.VALUE_CURRENT, parameter.Value);
            writer.Write(ParameterSaveCode.VALUE_TEXT, parameter.Description);
        ...
        /// For parsing <see cref="SimDoubleListParameter"/> see <see cref="ParseDoubleListParameter(DXFParserResultSet, DXFParserInfo)"/>
        /// </summary>
        ...
        public static SimBaseParameter ParseBaseParameter(DXFParserResultSet data, DXFParserInfo info)
        {
            ...
            else if (parameterType == ParameterType.DoubleList)
            {
                parsedParam = ParseDoubleListParameter(data, info);
            }
        ...
        private static SimDoubleListParameter ParseDoubleListParameter(DXFParserResultSet data, DXFParserInfo info)
        {
            var localId = data.Get<long>(ParamStructCommonSaveCode.ENTITY_LOCAL_ID, 0);
            var name = data.Get<string>(ParameterSaveCode.NAME, "");
            var category = data.Get<SimCategory>(ParameterSaveCode.CATEGORY, SimCategory.None);
            ...
            var stringValue = data.Get<string>(ParameterSaveCode.VALUE_CURRENT, "");
            SimParameterValueCollection<double> value = DXFDataConverter<SimParameterValueCollection<double>>.P.FromDXFString(stringValue, info);
            ...
            try
            {
                ...
                var parameter = new SimDoubleListParameter(localId, name,
            ...
            writer.WriteArray(ComponentInstanceSaveCode.INST_PARAMS, instance.InstanceParameterValuesPersistent, (item, iwriter) =>
            {
                ...
                switch (item.Key)
                {
                    ...
                    case SimEnumParameter eParam:
                        ...
                        break;
                    case SimDoubleListParameter dlParam:
                        iwriter.Write(ParameterSaveCode.PARAMTYPE, ParameterType.DoubleList);
                        iwriter.Write(ComponentInstanceSaveCode.INST_PARAM_VAL, (SimParameterValueCollection<double>)item.Value);
                        break;
                    default:
                        throw new NotSupportedException($"Writing instance parameter of type {item.Key.GetType()} is not supported");
                }
