...
namespace SIMULTAN.Exchange.Connectors
{
    ...
    /// </summary>
    [Flags]
    internal enum ConnectorConnectionState
    {
        /// <summary>
        /// Connection OK
        /// </summary>
    ...
    /// </summary>
    internal enum ConnectionChange
    {
        /// <summary>
        /// Connector unchanged
        /// </summary>
    ...
    /// </summary>
    [Flags]
    internal enum DisconnectionState
    {
        /// <summary>
    ...
    /// </summary>
    internal static class ConnectionStateEvaluator
    {
        /// <summary>
        ...
        /// <returns></returns>
        public static ConnectorConnectionState Evaluate(SimComponent _parent_source, BaseGeometry _parent_target, SimComponent _source, BaseGeometry _target)
        {
            ConnectorConnectionState evaluation = ConnectorConnectionState.OK;

            if (_source == null)
                evaluation |= ConnectorConnectionState.SOURCE_COMPONENT_NULL;
            if (_target == null)
                evaluation |= ConnectorConnectionState.TARGET_GEOMETRY_NULL;

            if (_source != null && _target != null)
            {
                if (!ConnectionStateEvaluator.AreAMatch(_source.InstanceType, _target))
                    evaluation |= ConnectorConnectionState.SOURCE_COMPONENT_TARGET_GEOMETRY_MISMATCH;
            }
        ...
        private static ConnectorConnectionState GetMatchState(SimComponent _parent, SimComponent _child)
        {
            if (_parent == null && _child == null)
            {
                return ConnectorConnectionState.OK;
            }
            else if (_parent == null)
            {
                ...
                if (c_rel == SimInstanceType.GeometricVolume || c_rel == SimInstanceType.GeometricSurface)
                    return ConnectorConnectionState.SOURCE_COMPONENT_IN_PARENT_MISSING;
                else
                    return ConnectorConnectionState.OK;
            }
            else if (_child == null)
            ...
            else
            {
                if (ConnectionStateEvaluator.AreAMatch(_parent, _child))
                    ...
                    return ConnectorConnectionState.SOURCE_COMPONENTS_MISMATCH;
            }
        }
        ...
        private static ConnectorConnectionState GetMatchState(BaseGeometry _parent, BaseGeometry _child)
        {
            if (_parent == null && _child == null)
            {
                return ConnectorConnectionState.OK;
            ...
            else if (_parent == null)
            {
                if (_child is Volume)
                    ...
                    return ConnectorConnectionState.TARGET_GEOMETRY_IN_PARENT_MISSING;
            }
            else if (_child == null)
            {
                return ConnectorConnectionState.OK;
            ...
            else
            {
                if (ConnectionStateEvaluator.AreAMatchInComponent(_parent, _child))
                    ...
                    return ConnectorConnectionState.TARGET_GEOMETRIES_MISMATCH;
            }
        }
