...
namespace SIMULTAN.Data.SimMath
{
    ...
    /// negative sizes.
    /// </summary>
    public partial struct SimRect3D : IFormattable
    {
        //------------------------------------------------------
        //
        //  Constructors
        ...
        public SimRect3D(SimPoint3D location, SimSize3D size)
        {
            if (size.IsEmpty)
            {
                this = s_empty;
        ...
        public SimRect3D(double x, double y, double z, double sizeX, double sizeY, double sizeZ)
        {
            if (sizeX < 0 || sizeY < 0 || sizeZ < 0)
            {
                throw new System.ArgumentException("Rect dimensions cannot be negative");
            }
        ...
        internal SimRect3D(SimPoint3D point1, SimPoint3D point2)
        {
        ...
        internal SimRect3D(SimPoint3D point, SimVector3D vector) : this(point, point + vector)
        {
        }
        ...
        /// </summary>
        public SimPoint3D Location
        {
            get
            {
                return new SimPoint3D(_x, _y, _z);
            }
            set
            {
                if (IsEmpty)
        ...
        /// </summary>
        public SimSize3D Size
        {
            get
            {
                if (IsEmpty)
                    return SimSize3D.Empty;
                else
                    return new SimSize3D(_sizeX, _sizeY, _sizeZ);
            }
            set
            {
                if (value.IsEmpty)
        ...
        public bool Contains(SimPoint3D point)
        {
        ...
        public bool Contains(SimRect3D rect)
        {
        ...
        /// <returns>True if the rectangle intersects with this rectangle. 
        /// False otherwise.</returns>
        public bool IntersectsWith(SimRect3D rect)
        {
            if (IsEmpty || rect.IsEmpty)
            {
                return false;
        ...
        public void Intersect(SimRect3D rect)
        {
        ...
        public static SimRect3D Intersect(SimRect3D rect1, SimRect3D rect2)
        {
        ...
        public void Union(SimRect3D rect)
        {
            if (IsEmpty)
            {
                this = rect;
        ...
        public static SimRect3D Union(SimRect3D rect1, SimRect3D rect2)
        {
            rect1.Union(rect2);
            return rect1;
        }
        ...
        public void Union(SimPoint3D point)
        {
            Union(new SimRect3D(point, point));
        }
        ...
        public static SimRect3D Union(SimRect3D rect, SimPoint3D point)
        {
            rect.Union(new SimRect3D(point, point));
            return rect;
        }
        ...
        public void Offset(SimVector3D offsetVector)
        {
        ...
        /// <param name="offsetVector"></param>
        /// <returns></returns>
        public static SimRect3D Offset(SimRect3D rect, SimVector3D offsetVector)
        {
        ...
        /// <param name="offsetZ"></param>
        /// <returns></returns>
        public static SimRect3D Offset(SimRect3D rect, double offsetX, double offsetY, double offsetZ)
        {
        ...
        internal readonly static SimRect3D Infinite = CreateInfiniteRect3D();
        ...
        private static SimRect3D CreateEmptyRect3D()
        {
            SimRect3D empty = new SimRect3D();
        ...
        private static SimRect3D CreateInfiniteRect3D()
        {
            ...
            SimRect3D infinite = new SimRect3D();
        ...
        private readonly static SimRect3D s_empty = CreateEmptyRect3D();
