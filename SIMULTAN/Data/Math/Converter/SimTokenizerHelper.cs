...
{
    internal class SimTokenizerHelper
    {
        /// <summary>
        ...
        internal SimTokenizerHelper(string str, IFormatProvider formatProvider)
        {
        ...
        internal SimTokenizerHelper(string str,
                                 char quoteChar,
                                 char separator)
        {
        ...
        internal void LastTokenRequired()
        {
            ...
            {
                throw new System.InvalidOperationException(string.Format("Extra data encountered at position {0} while parsing '{1}'", _charIndex, _str));
            }
        }
        ...
        internal string NextTokenRequired()
        {
            if (!NextToken(false))
            {
                throw new System.InvalidOperationException(string.Format("Premature string termination encountered while parsing '{0}'", _str));
            }
        ...
        internal bool NextToken(bool allowQuotedToken, char separator)
        {
            ...
            if (quoteCount > 0)
            {
                throw new System.InvalidOperationException(string.Format("Missing end quote encoutered while parsing '{0}'", _str));
            }
            ...
            {
                throw new System.InvalidOperationException(string.Format("Empty token encountered at position {0} while parsing '{1}'", _charIndex, _str));
            }
