...
namespace SIMULTAN.Data.SimMath
{
    ...
    public partial struct SimRect
    {
        ...
        /// </summary>
        public SimRect(SimPoint location,
                    SimSize size)
        {
            if (size.IsEmpty)
            {
                    ...
                    double height)
        {
            if (width < 0 || height < 0)
            {
                throw new System.ArgumentException("Width and heigt cannot be negative");
            }
        ...
        /// </summary>
        public SimRect(SimPoint point1,
                    SimPoint point2)
        {
        ...
        /// </summary>
        public SimRect(SimPoint point,
                    SimVector vector) : this(point, point + vector)
        {
        }
        ...
        /// </summary>
        public SimPoint Location
        {
            get
            {
                return new SimPoint(_x, _y);
            }
            set
            {
                if (IsEmpty)
        ...
        public SimSize Size
        {
            ...
            {
                if (IsEmpty)
                    return SimSize.Empty;
                return new SimSize(_width, _height);
            }
            set
            {
                if (value.IsEmpty)
        ...
        public double Width
        {
            ...
            set
            {
                ...
                if (value < 0)
                {
                    throw new System.ArgumentException("Rect width cannot be negative");
                }
        ...
        public double Height
        {
            ...
            set
            {
                ...
                if (value < 0)
                {
                    throw new System.ArgumentException("Rect heigt cannot be negative");
                }
        ...
        /// </summary>
        public SimPoint TopLeft
        {
            get
            {
                return new SimPoint(Left, Top);
            }
        }
        ...
        /// </summary>
        public SimPoint TopRight
        {
            get
            {
                return new SimPoint(Right, Top);
            }
        }
        ...
        /// </summary>
        public SimPoint BottomLeft
        {
            get
            {
                return new SimPoint(Left, Bottom);
            }
        }
        ...
        /// </summary>
        public SimPoint BottomRight
        {
            get
            {
                return new SimPoint(Right, Bottom);
            }
        }
        ...
        /// Returns false otherwise
        /// </returns>
        public bool Contains(SimPoint point)
        {
        ...
        /// Returns false otherwise
        /// </summary>
        public bool Contains(SimRect rect)
        {
        ...
        public bool IntersectsWith(SimRect rect)
        {
            if (IsEmpty || rect.IsEmpty)
            {
                return false;
        ...
        public void Intersect(SimRect rect)
        {
        ...
        /// If either this or rect are Empty, the result is Empty as well.
        /// </summary>
        public static SimRect Intersect(SimRect rect1, SimRect rect2)
        {
        ...
        /// </summary>
        public void Union(SimRect rect)
        {
            if (IsEmpty)
            {
                this = rect;
        ...
        /// </summary>
        public static SimRect Union(SimRect rect1, SimRect rect2)
        {
            rect1.Union(rect2);
            return rect1;
        }
        ...
        /// </summary>
        public void Union(SimPoint point)
        {
            Union(new SimRect(point, point));
        }

        /// <summary>
        /// Union - Return the result of the union of rect and point.
        /// </summary>
        public static SimRect Union(SimRect rect, SimPoint point)
        {
            rect.Union(new SimRect(point, point));
            return rect;
        }
        ...
        /// </summary>
        public void Offset(SimVector offsetVector)
        {
            if (IsEmpty)
            {
                throw new System.InvalidOperationException("Cannot call method on empty rect");
            }
        ...
        /// If this is Empty, this method is illegal.
        /// </summary>
        public static SimRect Offset(SimRect rect, SimVector offsetVector)
        {
        ...
        /// If this is Empty, this method is illegal.
        /// </summary>
        public static SimRect Offset(SimRect rect, double offsetX, double offsetY)
        {
        ...
        /// If this is Empty, this method is illegal.
        /// </summary>
        public void Inflate(SimSize size)
        {
        ...
        /// If this is Empty, this method is illegal.
        /// </summary>
        public static SimRect Inflate(SimRect rect, SimSize size)
        {
        ...
        /// If this is Empty, this method is illegal.
        /// </summary>
        public static SimRect Inflate(SimRect rect, double width, double height)
        {
        ...
        public static SimRect Transform(SimRect rect, SimMatrix matrix)
        {
            SimMatrixUtil.TransformRect(ref rect, ref matrix);
            return rect;
        }
        ...
        public void Transform(SimMatrix matrix)
        {
            SimMatrixUtil.TransformRect(ref this, ref matrix);
        }
        ...
        static private SimRect CreateEmptyRect()
        {
            SimRect rect = new SimRect();
        ...
        private readonly static SimRect s_empty = CreateEmptyRect();
