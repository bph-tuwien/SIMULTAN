...
namespace SIMULTAN.Data.SimMath
{
    ...
    public partial struct SimSize
    {
        ...
        public SimSize(double width, double height)
        {
            if (width < 0 || height < 0)
            {
                throw new System.ArgumentException("Width and height of a size cannot be negative.");
            }
        ...
        public double Width
        {
            ...
            set
            {
                if (IsEmpty)
                {
                    throw new System.InvalidOperationException("Size cannot be empty");
                }
        ...
        public static explicit operator SimVector(SimSize size)
        {
            return new SimVector(size._width, size._height);
        }
        ...
        public static explicit operator SimPoint(SimSize size)
        {
            return new SimPoint(size._width, size._height);
        }
        ...
        static private SimSize CreateEmptySize()
        {
            SimSize size = new SimSize();
        ...
        private readonly static SimSize s_empty = CreateEmptySize();
