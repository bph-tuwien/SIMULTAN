...
namespace SIMULTAN.Data.SimMath
{
    ...
    /// Defaults to (0,0,0,0).
    /// </summary>
    public partial struct SimPoint4D
    {
        //------------------------------------------------------
        //
        //  Constructors
        ...
        public SimPoint4D(double x, double y, double z, double w)
        {
            _x = x;
            _y = y;
            _z = z;
        ...
        public static SimPoint4D operator +(SimPoint4D point1, SimPoint4D point2)
        {
            return new SimPoint4D(point1._x + point2._x,
                               point1._y + point2._y,
                               point1._z + point2._z,
                               point1._w + point2._w);
        }
        ...
        /// <param name="point2">Second point being added.</param>
        /// <returns>Result of addition.</returns>
        public static SimPoint4D Add(SimPoint4D point1, SimPoint4D point2)
        {
            return new SimPoint4D(point1._x + point2._x,
                               point1._y + point2._y,
                               point1._z + point2._z,
        ...
        /// <param name="point2">Point being subtracted.</param>
        /// <returns>Vector between the two points.</returns>
        public static SimPoint4D Subtract(SimPoint4D point1, SimPoint4D point2)
        {
            return new SimPoint4D(point1._x - point2._x,
                               point1._y - point2._y,
                               point1._z - point2._z,
        ...
        public static SimPoint4D operator *(SimPoint4D point, SimMatrix3D matrix)
        {
        ...
        /// <param name="matrix">Transformation matrix applied to the point.</param>
        /// <returns>Result of the transformation matrix applied to the point.</returns>
        public static SimPoint4D Multiply(SimPoint4D point, SimMatrix3D matrix)
        {
            return matrix.Transform(point);
        }
