...
namespace SIMULTAN.Data.SimMath
{
    ...
    /// </summary>
    public partial struct SimQuaternion : IFormattable
    {
        //------------------------------------------------------
        //
        //  Constructors
        ...
        public SimQuaternion(double x, double y, double z, double w)
        {
            _x = x;
            _y = y;
            _z = z;
        ...
        public SimQuaternion(SimVector3D axisOfRotation, double angleInDegrees)
        {
            ...
            if (length == 0)
                throw new System.InvalidOperationException("Quaternion axis cannot be zero length");
            SimVector3D v = (axisOfRotation / length) * Math.Sin(0.5 * angleInRadians);
            _x = v.X;
            _y = v.Y;
            _z = v.Z;
        ...
        ///     Identity quaternion
        /// </summary>
        public static SimQuaternion Identity
        {
            get
            {
                return s_identity;
        ...
        public SimVector3D Axis
        {
            ...
            get
            {
                ...
                {
                    return new SimVector3D(0, 1, 0);
                }
                else
                {
                    SimVector3D v = new SimVector3D(_x, _y, _z);
                    v.Normalize();
                    return v;
                }
            }
        ...
        public bool IsNormalized
        {
            get
            {
                ...
                return SimDoubleUtil.IsOne(norm2);
            }
        }
        ...
        public static SimQuaternion operator +(SimQuaternion left, SimQuaternion right)
        {
            if (right.IsDistinguishedIdentity)
            {
                if (left.IsDistinguishedIdentity)
                {
                    return new SimQuaternion(0, 0, 0, 2);
                }
                else
                {
            ...
            {
                return new SimQuaternion(left._x + right._x,
                                      left._y + right._y,
                                      left._z + right._z,
                                      left._w + right._w);
            }
        ...
        /// <param name="right">Second quaternion being added.</param>
        /// <returns>Result of addition.</returns>
        public static SimQuaternion Add(SimQuaternion left, SimQuaternion right)
        {
            return (left + right);
        }
        ...
        public static SimQuaternion operator -(SimQuaternion left, SimQuaternion right)
        {
            if (right.IsDistinguishedIdentity)
            {
                if (left.IsDistinguishedIdentity)
                {
                    return new SimQuaternion(0, 0, 0, 0);
                }
                else
                {
                    // We know left is not distinguished identity here.
            ...
            {
                // We know right is not distinguished identity here.
                return new SimQuaternion(-right._x, -right._y, -right._z, 1 - right._w);
            }
            else
            {
                return new SimQuaternion(left._x - right._x,
        ...
        /// <param name="right">Quaternion to subtract from the first quaternion.</param>
        /// <returns>Result of subtraction.</returns>
        public static SimQuaternion Subtract(SimQuaternion left, SimQuaternion right)
        {
            return (left - right);
        }
        ...
        public static SimQuaternion operator *(SimQuaternion left, SimQuaternion right)
        {
            ...
            SimQuaternion result = new SimQuaternion(x, y, z, w);
            return result;
        }
        ...
        /// <param name="right">Second quaternion.</param>
        /// <returns>Result of multiplication.</returns>
        public static SimQuaternion Multiply(SimQuaternion left, SimQuaternion right)
        {
            return left * right;
        }
        ...
        public static SimQuaternion Slerp(SimQuaternion from, SimQuaternion to, double t)
        {
        ...
        /// <returns>SLERP-interpolated quaternion between the two given quaternions.</returns>
        public static SimQuaternion Slerp(SimQuaternion from, SimQuaternion to, double t, bool useShortestPath)
        {
            ...
            else if (cosOmega < minCosine)
            {
                ...
                to = new SimQuaternion(-from.Y, from.X, -from.W, from.Z);
            ...
            return new SimQuaternion(scaleFrom * from._x + scaleTo * to._x,
        ...
        private static SimQuaternion GetIdentity()
        {
            // This code is called only once.
            SimQuaternion q = new SimQuaternion(0, 0, 0, 1);
        ...
        // Default identity
        private static SimQuaternion s_identity = GetIdentity();
