...
namespace SIMULTAN.Data.SimMath
{
    ...
    internal static class SimMatrixUtil
    {
        /// <summary>
        ...
        internal static void TransformRect(ref SimRect rect, ref SimMatrix matrix)
        {
            if (rect.IsEmpty)
            {
                return;
            ...
            if (matrixType == MatrixTypes.TRANSFORM_IS_UNKNOWN)
            {
                ...
                SimPoint point0 = matrix.Transform(rect.TopLeft);
                SimPoint point1 = matrix.Transform(rect.TopRight);
                SimPoint point2 = matrix.Transform(rect.BottomRight);
                SimPoint point3 = matrix.Transform(rect.BottomLeft);
        ...
        /// </summary>
        internal static void MultiplyMatrix(ref SimMatrix matrix1, ref SimMatrix matrix2)
        {
        ...
        internal static void PrependOffset(
            ref SimMatrix matrix,
            double offsetX,
            double offsetY)
        {
            if (matrix._type == MatrixTypes.TRANSFORM_IS_IDENTITY)
            {
                matrix = new SimMatrix(1, 0, 0, 1, offsetX, offsetY);
