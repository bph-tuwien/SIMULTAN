...
namespace SIMULTAN.Data.SimMath
{
    ...
    public partial struct SimMatrix : IFormattable
    {
        ...
        ///             \ offsetX, offsetY, 1 /
        /// </summary>
        public SimMatrix(double m11, double m12,
        ...
        /// Identity
        /// </summary>
        public static SimMatrix Identity
        {
            get
            {
                return s_identity;
        ...
        /// </summary>
        public static SimMatrix operator *(SimMatrix trans1, SimMatrix trans2)
        {
            SimMatrixUtil.MultiplyMatrix(ref trans1, ref trans2);
        ...
        /// Multiply
        /// </summary>
        public static SimMatrix Multiply(SimMatrix trans1, SimMatrix trans2)
        {
            SimMatrixUtil.MultiplyMatrix(ref trans1, ref trans2);
            trans1.Debug_CheckType();
            return trans1;
        ...
        public void Append(SimMatrix matrix)
        {
            this *= matrix;
        }
        ...
        public void Prepend(SimMatrix matrix)
        {
            this = matrix * this;
        }
        ...
        public SimPoint Transform(SimPoint point)
        {
            SimPoint newPoint = point;
        ...
        public void Transform(SimPoint[] points)
        {
            if (points != null)
            {
        ...
        public SimVector Transform(SimVector vector)
        {
            SimVector newVector = vector;
        ...
        public void Transform(SimVector[] vectors)
        {
            if (vectors != null)
            {
        ...
        public void Invert()
        {
            ...
            if (SimDoubleUtil.IsZero(determinant))
            {
                throw new System.InvalidOperationException("Matrix is not inversible");
            }
        ...
        internal static SimMatrix CreateRotationRadians(double angle)
        {
        ...
        /// <param name='centerX'>The centerX of rotation</param>
        /// <param name='centerY'>The centerY of rotation</param>
        internal static SimMatrix CreateRotationRadians(double angle, double centerX, double centerY)
        {
        ...
        internal static SimMatrix CreateScaling(double scaleX, double scaleY, double centerX, double centerY)
        {
            SimMatrix matrix = new SimMatrix();
        ...
        /// <param name='scaleX'>The scale factor in the x dimension</param>
        /// <param name='scaleY'>The scale factor in the y dimension</param>
        internal static SimMatrix CreateScaling(double scaleX, double scaleY)
        {
            SimMatrix matrix = new SimMatrix();
            matrix.SetMatrix(scaleX, 0,
                             0, scaleY,
        ...
        /// <param name='skewX'>The skew angle in the x dimension in degrees</param>
        /// <param name='skewY'>The skew angle in the y dimension in degrees</param>
        internal static SimMatrix CreateSkewRadians(double skewX, double skewY)
        {
            SimMatrix matrix = new SimMatrix();
        ...
        internal static SimMatrix CreateTranslation(double offsetX, double offsetY)
        {
            SimMatrix matrix = new SimMatrix();
        ...
        /// </summary>
        private static SimMatrix CreateIdentity()
        {
            SimMatrix matrix = new SimMatrix();
            matrix.SetMatrix(1, 0,
                             0, 1,
