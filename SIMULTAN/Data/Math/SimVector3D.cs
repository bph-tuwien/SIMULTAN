...
namespace SIMULTAN.Data.SimMath
{
    ...
    /// </summary>
    public partial struct SimVector3D
    {
        //------------------------------------------------------
        //
        //  Constructors
        ...
        public SimVector3D(double x, double y, double z)
        {
            _x = x;
            _y = y;
            _z = z;
        ...
        /// </returns>
        public static double AngleBetween(SimVector3D vector1, SimVector3D vector2)
        {
            vector1.Normalize();
            vector2.Normalize();
            ...
            return SimM3DUtil.RadiansToDegrees(theta);
        }
        ...
        public static SimVector3D operator -(SimVector3D vector)
        {
            return new SimVector3D(-vector._x, -vector._y, -vector._z);
        }
        ...
        public static SimVector3D operator +(SimVector3D vector1, SimVector3D vector2)
        {
            return new SimVector3D(vector1._x + vector2._x,
        ...
        /// <param name="vector2">Second vector being added.</param>
        /// <returns>Result of addition.</returns>
        public static SimVector3D Add(SimVector3D vector1, SimVector3D vector2)
        {
            return new SimVector3D(vector1._x + vector2._x,
                                vector1._y + vector2._y,
                                vector1._z + vector2._z);
        ...
        /// <param name="vector2">Vector being subtracted.</param>
        /// <returns>Result of subtraction.</returns>
        public static SimVector3D Subtract(SimVector3D vector1, SimVector3D vector2)
        {
            return new SimVector3D(vector1._x - vector2._x,
                                vector1._y - vector2._y,
                                vector1._z - vector2._z);
        ...
        /// <returns>Result of addition.</returns>
        public static SimPoint3D operator +(SimVector3D vector, SimPoint3D point)
        {
            return new SimPoint3D(vector._x + point._x,
                               vector._y + point._y,
                               vector._z + point._z);
        }
        ...
        /// <param name="point">Point being offset by the given vector.</param>
        /// <returns>Result of addition.</returns>
        public static SimPoint3D Add(SimVector3D vector, SimPoint3D point)
        {
            return new SimPoint3D(vector._x + point._x,
                               vector._y + point._y,
                               vector._z + point._z);
        ...
        /// <param name="point">Point being offset by the given vector.</param>
        /// <returns>Result of subtraction.</returns>
        public static SimPoint3D Subtract(SimVector3D vector, SimPoint3D point)
        {
            return new SimPoint3D(vector._x - point._x,
                               vector._y - point._y,
                               vector._z - point._z);
        ...
        public static SimVector3D operator *(SimVector3D vector, double scalar)
        {
            return new SimVector3D(vector._x * scalar,
                                vector._y * scalar,
                                vector._z * scalar);
        }
        ...
        /// <param name="scalar">Scalar value by which the vector is multiplied.</param>
        /// <returns>Result of multiplication.</returns>
        public static SimVector3D Multiply(SimVector3D vector, double scalar)
        {
            return new SimVector3D(vector._x * scalar,
                                vector._y * scalar,
                                vector._z * scalar);
        ...
        /// <param name="vector">Vector being multiplied.</param>
        /// <returns>Result of multiplication.</returns>
        public static SimVector3D operator *(double scalar, SimVector3D vector)
        {
            return new SimVector3D(vector._x * scalar,
                                vector._y * scalar,
                                vector._z * scalar);
        ...
        /// <param name="vector">Vector being multiplied.</param>
        /// <returns>Result of multiplication.</returns>
        public static SimVector3D Multiply(double scalar, SimVector3D vector)
        {
            return new SimVector3D(vector._x * scalar,
                                vector._y * scalar,
                                vector._z * scalar);
        ...
        /// <param name="scalar">Scalar value by which we divide the vector.</param>
        /// <returns>Result of division.</returns>
        public static SimVector3D Divide(SimVector3D vector, double scalar)
        {
            return vector * (1.0 / scalar);
        }
        ...
        /// <returns>Result of multiplication.</returns>
        public static SimVector3D operator *(SimVector3D vector, SimMatrix3D matrix)
        {
        ...
        /// <param name="matrix">Transformation matrix applied to the vector.</param>
        /// <returns>Result of multiplication.</returns>
        public static SimVector3D Multiply(SimVector3D vector, SimMatrix3D matrix)
        {
            return matrix.Transform(vector);
        }
        ...
        public static double DotProduct(SimVector3D vector1, SimVector3D vector2)
        {
        ...
        /// </summary>
        internal static double DotProduct(ref SimVector3D vector1, ref SimVector3D vector2)
        {
        ...
        public static SimVector3D CrossProduct(SimVector3D vector1, SimVector3D vector2)
        {
            SimVector3D result;
        ...
        /// vector1 and vector2 to a passed by ref for perf and ARE NOT MODIFIED
        /// </summary>
        internal static void CrossProduct(ref SimVector3D vector1, ref SimVector3D vector2, out SimVector3D result)
        {
        ...
        public static explicit operator SimPoint3D(SimVector3D vector)
        {
            return new SimPoint3D(vector._x, vector._y, vector._z);
        }
        ...
        public static explicit operator SimSize3D(SimVector3D vector)
        {
            return new SimSize3D(Math.Abs(vector._x), Math.Abs(vector._y), Math.Abs(vector._z));
        }
