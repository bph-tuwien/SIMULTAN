...
{
    [Serializable]
    [TypeConverter(typeof(SimRectConverter))]
    partial struct SimRect : IFormattable
    {
        //------------------------------------------------------
        //
        //  Public Methods
        ...
        public static bool operator ==(SimRect rect1, SimRect rect2)
        {
        ...
        /// <param name='rect1'>The first Rect to compare</param>
        /// <param name='rect2'>The second Rect to compare</param>
        public static bool Equals(SimRect rect1, SimRect rect2)
        {
            if (rect1.IsEmpty)
            {
        ...
        {
            if ((null == o) || !(o is SimRect))
            {
                return false;
            }

            SimRect value = (SimRect)o;
            return SimRect.Equals(this, value);
        }
        ...
        public bool Equals(SimRect value)
        {
            return SimRect.Equals(this, value);
        }
        /// <summary>
        ...
        /// </summary>
        public static SimRect Parse(string source)
        {
