...
{
    [Serializable]
    [TypeConverter(typeof(SimQuaternionConverter))]
    partial struct SimQuaternion : IFormattable
    {
        //------------------------------------------------------
        //
        //  Public Methods
        ...
        public static bool operator ==(SimQuaternion quaternion1, SimQuaternion quaternion2)
        {
        ...
        /// <param name='quaternion1'>The first Quaternion to compare</param>
        /// <param name='quaternion2'>The second Quaternion to compare</param>
        public static bool Equals(SimQuaternion quaternion1, SimQuaternion quaternion2)
        {
            if (quaternion1.IsDistinguishedIdentity || quaternion2.IsDistinguishedIdentity)
            {
                return quaternion1.IsIdentity == quaternion2.IsIdentity;
        ...
        {
            if ((null == o) || !(o is SimQuaternion))
            {
                return false;
            }

            SimQuaternion value = (SimQuaternion)o;
            return SimQuaternion.Equals(this, value);
        }
        ...
        public bool Equals(SimQuaternion value)
        {
            return SimQuaternion.Equals(this, value);
        }
        /// <summary>
        ...
        /// </summary>
        public static SimQuaternion Parse(string source)
        {
