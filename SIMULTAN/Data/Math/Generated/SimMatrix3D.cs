...
{
    [Serializable]
    [TypeConverter(typeof(SimMatrix3DConverter))]
    partial struct SimMatrix3D : IFormattable
    {
        //------------------------------------------------------
        //
        //  Public Methods
        ...
        public static bool operator ==(SimMatrix3D matrix1, SimMatrix3D matrix2)
        {
        ...
        /// <param name='matrix1'>The first Matrix3D to compare</param>
        /// <param name='matrix2'>The second Matrix3D to compare</param>
        public static bool Equals(SimMatrix3D matrix1, SimMatrix3D matrix2)
        {
            if (matrix1.IsDistinguishedIdentity || matrix2.IsDistinguishedIdentity)
            {
                return matrix1.IsIdentity == matrix2.IsIdentity;
        ...
        {
            if ((null == o) || !(o is SimMatrix3D))
            {
                return false;
            }

            SimMatrix3D value = (SimMatrix3D)o;
            return SimMatrix3D.Equals(this, value);
        }
        ...
        public bool Equals(SimMatrix3D value)
        {
            return SimMatrix3D.Equals(this, value);
        }
        /// <summary>
        ...
        /// </summary>
        public static SimMatrix3D Parse(string source)
        {
