...
{
    [Serializable]
    [TypeConverter(typeof(SimRect3DConverter))]
    partial struct SimRect3D : IFormattable
    {
        //------------------------------------------------------
        //
        //  Public Methods
        ...
        public static bool operator ==(SimRect3D rect1, SimRect3D rect2)
        {
        ...
        /// <param name='rect1'>The first Rect3D to compare</param>
        /// <param name='rect2'>The second Rect3D to compare</param>
        public static bool Equals(SimRect3D rect1, SimRect3D rect2)
        {
            if (rect1.IsEmpty)
            {
        ...
        {
            if ((null == o) || !(o is SimRect3D))
            {
                return false;
            }

            SimRect3D value = (SimRect3D)o;
            return SimRect3D.Equals(this, value);
        }
        ...
        public bool Equals(SimRect3D value)
        {
            return SimRect3D.Equals(this, value);
        }
        /// <summary>
        ...
        /// </summary>
        public static SimRect3D Parse(string source)
        {
