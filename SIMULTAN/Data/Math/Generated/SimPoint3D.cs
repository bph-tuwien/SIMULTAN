...
{
    [Serializable]
    [TypeConverter(typeof(SimPoint3DConverter))]
    partial struct SimPoint3D : IFormattable
    {
        //------------------------------------------------------
        //
        //  Public Methods
        ...
        public static bool operator ==(SimPoint3D point1, SimPoint3D point2)
        {
        ...
        /// <param name='point1'>The first Point3D to compare</param>
        /// <param name='point2'>The second Point3D to compare</param>
        public static bool Equals(SimPoint3D point1, SimPoint3D point2)
        {
        ...
        {
            if ((null == o) || !(o is SimPoint3D))
            {
                return false;
            }

            SimPoint3D value = (SimPoint3D)o;
            return SimPoint3D.Equals(this, value);
        }
        ...
        public bool Equals(SimPoint3D value)
        {
            return SimPoint3D.Equals(this, value);
        }
        /// <summary>
        ...
        /// </summary>
        public static SimPoint3D Parse(string source)
        {
