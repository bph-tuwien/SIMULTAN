...
{
    [Serializable]
    [TypeConverter(typeof(SimSizeConverter))]
    partial struct SimSize : IFormattable
    {
        //------------------------------------------------------
        //
        //  Public Methods
        ...
        public static bool operator ==(SimSize size1, SimSize size2)
        {
        ...
        /// <param name='size1'>The first Size to compare</param>
        /// <param name='size2'>The second Size to compare</param>
        public static bool Equals(SimSize size1, SimSize size2)
        {
            if (size1.IsEmpty)
            {
        ...
        {
            if ((null == o) || !(o is SimSize))
            {
                return false;
            }

            SimSize value = (SimSize)o;
            return SimSize.Equals(this, value);
        }
        ...
        public bool Equals(SimSize value)
        {
            return SimSize.Equals(this, value);
        }
        /// <summary>
        ...
        /// </summary>
        public static SimSize Parse(string source)
        {
