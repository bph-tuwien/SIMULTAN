...
{
    [Serializable]
    [TypeConverter(typeof(SimMatrixConverter))]
    partial struct SimMatrix : IFormattable
    {
        //------------------------------------------------------
        //
        //  Public Methods
        ...
        public static bool operator ==(SimMatrix matrix1, SimMatrix matrix2)
        {
        ...
        /// <param name='matrix1'>The first Matrix to compare</param>
        /// <param name='matrix2'>The second Matrix to compare</param>
        public static bool Equals(SimMatrix matrix1, SimMatrix matrix2)
        {
            if (matrix1.IsDistinguishedIdentity || matrix2.IsDistinguishedIdentity)
            {
                return matrix1.IsIdentity == matrix2.IsIdentity;
        ...
        {
            if ((null == o) || !(o is SimMatrix))
            {
                return false;
            }

            SimMatrix value = (SimMatrix)o;
            return SimMatrix.Equals(this, value);
        }
        ...
        public bool Equals(SimMatrix value)
        {
            return SimMatrix.Equals(this, value);
        }
        /// <summary>
        ...
        /// </summary>
        public static SimMatrix Parse(string source)
        {
