...
namespace SIMULTAN.Data.SimMath
{
    ...
    /// </summary>
    public sealed class SimMatrixConverter : TypeConverter
    {
        /// <summary>
        ...
        {
            if (destinationType != null && value is SimMatrix)
            {
                SimMatrix instance = (SimMatrix)value;
