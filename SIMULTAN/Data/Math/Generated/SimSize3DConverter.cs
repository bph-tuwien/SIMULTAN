...
namespace SIMULTAN.Data.SimMath
{
    ...
    /// </summary>
    public sealed class SimSize3DConverter : TypeConverter
    {
        /// <summary>
        ...
        {
            if (destinationType != null && value is SimSize3D)
            {
                SimSize3D instance = (SimSize3D)value;
