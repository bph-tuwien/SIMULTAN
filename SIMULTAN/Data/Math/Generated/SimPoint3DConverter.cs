...
namespace SIMULTAN.Data.SimMath
{
    ...
    /// </summary>
    public sealed class SimPoint3DConverter : TypeConverter
    {
        /// <summary>
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
        {
            ...
            if (source != null)
            {
                return SimPoint3D.Parse(source);
            }
        ...
        {
            if (destinationType != null && value is SimPoint3D)
            {
                SimPoint3D instance = (SimPoint3D)value;
