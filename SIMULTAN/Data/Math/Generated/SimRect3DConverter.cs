...
namespace SIMULTAN.Data.SimMath
{
    ...
    /// </summary>
    public sealed class SimRect3DConverter : TypeConverter
    {
        /// <summary>
        ...
        {
            if (destinationType != null && value is SimRect3D)
            {
                SimRect3D instance = (SimRect3D)value;
