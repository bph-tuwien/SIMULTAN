...
namespace SIMULTAN.Data.SimMath
{
    ...
    /// </summary>
    public sealed class SimPointConverter : TypeConverter
    {
        /// <summary>
        ...
        {
            if (destinationType != null && value is SimPoint)
            {
                SimPoint instance = (SimPoint)value;
