...
namespace SIMULTAN.Data.SimMath
{
    ...
    /// </summary>
    public sealed class SimVectorConverter : TypeConverter
    {
        /// <summary>
        ...
        {
            if (destinationType != null && value is SimVector)
            {
                SimVector instance = (SimVector)value;
