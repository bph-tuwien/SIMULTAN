...
namespace SIMULTAN.Data.SimMath
{
    ...
    /// </summary>
    public sealed class SimPoint4DConverter : TypeConverter
    {
        /// <summary>
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
        {
            ...
            if (source != null)
            {
                return SimPoint4D.Parse(source);
            }
        ...
        {
            if (destinationType != null && value is SimPoint4D)
            {
                SimPoint4D instance = (SimPoint4D)value;
