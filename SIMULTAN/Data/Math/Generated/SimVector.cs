...
{
    [Serializable]
    [TypeConverter(typeof(SimVectorConverter))]
    partial struct SimVector : IFormattable
    {
        //------------------------------------------------------
        //
        //  Public Methods
        ...
        public static bool operator ==(SimVector vector1, SimVector vector2)
        {
        ...
        /// <param name='vector1'>The first Vector to compare</param>
        /// <param name='vector2'>The second Vector to compare</param>
        public static bool Equals(SimVector vector1, SimVector vector2)
        {
        ...
        {
            if ((null == o) || !(o is SimVector))
            {
                return false;
            }

            SimVector value = (SimVector)o;
            return SimVector.Equals(this, value);
        }
        ...
        public bool Equals(SimVector value)
        {
            return SimVector.Equals(this, value);
        }
        /// <summary>
        ...
        /// </summary>
        public static SimVector Parse(string source)
        {
