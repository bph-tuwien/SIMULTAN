...
{
    /// <summary>
    /// A management class for a single file containing <see cref="ImageRecord"/> instance.
    /// </summary>
    public class ManagedImageFile : ManagedFile
    {
        /// <summary>
        /// Initializes a ManagedImageFile.
        /// </summary>
        ...
        public ManagedImageFile(ExtendedProjectData projectData, ManagedFileCollection _owner, FileInfo _file)
        ...
        internal ManagedImageFile(ManagedImageFile _original, FileInfo _new_file_location)
        ...
        {
            ProjectIO.SaveImageLibraryFile(this.File, ProjectData.ImageLibraryManager);
        ...
        {
            ProjectIO.OpenImageLibraryFile(this.File, ProjectData.ImageLibraryManager);
        }
    }
}
