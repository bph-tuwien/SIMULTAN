...
{
    // Source: http://csharphelper.com/blog/2017/01/see-processes-file-locked-c/
    ...
    public class LockTools
    {
        ...
        static public List<Process> FindLockers(string filename)
        {
            ...
            int result = RmStartSession(out uint session_handle, 0, session_key);
            if (result != 0)
            ...
            try
            {
                ...
                result = RmGetList(session_handle, out uint pnProcInfoNeeded,
